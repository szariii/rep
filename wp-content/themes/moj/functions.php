...
function custom_theme_assets()
{
    ...
    wp_enqueue_script('script', get_template_directory_uri() . '/assets/src/js/przycisk.js', array('jquery'), null, true);
...
function handleUpdateUser() 
{
    ...
    wp_send_json_success(array('status' => 201, 'message' => 'Zmieniono dane użytkownika' ));
